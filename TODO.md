...
- 2026-09-12 — Login HMAC uses `CURATOR_ADMIN_PASSWORD` when `CURATOR_SESSION_SECRET` is unset (production included). Dropped unused `@reduxjs/toolkit` / `react-redux` / `@base-org/account`. Vitest 4.1.11; sharp ≥0.35.4.
