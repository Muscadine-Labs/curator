*TO work on today:
- Delete the files for the ability to change vault perameters like in Roles, adaptors, Caps, Parameters, timelocks, pending, queues. We dont need them, and they dont work. Keep all of the function in Allocation because they work, and the ability for V2 for what the liqudity adaptor is. Review your work and allocation for V1 and V2.
- On constants I will be adding more V2 vaults on base, this time they would be Base Frontier vaults, create the pathway for me to access before I impliment. Here is our Muscadine USDC Frontier vault address on BASE: 0x314fD07319ef645bA7D548915CCd91F4788A1839 .
